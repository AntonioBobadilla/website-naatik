...
const Reporte = ({differencesImages, plots, noDifferences, fileName_size, fileRows, status, i, Allclusts, generalInfoChurnData, confussionMatrix, modelAccuracy, allHyperparams}) => {
    return ( 
        <div className={styles.reporte}>
            ...
            <div className={styles.section}>
                ...
                <ClassificationModel allHyperparams={allHyperparams} modelAccuracy={modelAccuracy} confussionMatrix={confussionMatrix} />
            </div>
        </div>
     );
}
